...
<body style="overflow-x: hidden;">
    <div id="app">
                        ...
                        <div class="header__right">
                            <ul>
                                @guest
                                    ...
                                    @if (Route::has('login'))
                                        <li class="nav-item">
                                            <a class="nav-link" style="margin-right:100px"
                            ...
                            <form method="POST" action="{{ route('anime.search.shows') }}"
                                class="form-inline my-2 my-lg-0">
                                @csrf
                                <input class="form-control mr-sm-2" type="search" name="show" placeholder="Search"
                                    aria-label="Search" style="margin-top:-63px;margin-left:-225px">
                            </form>
        ...
        <main class="py-4" style="background: #0b0c2a;min-height:500px">
            @yield('content')
        </main>
    </div>

    <!-- Footer Section Begin -->
    <footer class="footer" style="background: #070720">
        <div class="page-up">
